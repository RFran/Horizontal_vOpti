...
#--------------Scan-------------------------------------------------------------
    ...
    def Scan(self):
        ...
        diameterZ = convert_str_int(self.Di.text(),35)
        diameterY = convert_str_int(self.Di.text(),20)
        range_focus = convert_str_int(self.focus.text(),0.5)
...
#
        ...
        param = {'S': ('cont', [-range_focus, range_focus]),
                 'Z': ('cont', [-50, 50]),
                 'Y': ('cont', [-50, 50])}
#
        #np.random.seed(20)
        ...
        #self.Yscan.setText('-' + str(gpgo.getResultY())   # Enlever les comentaires tant qui il n'y a pas le module
        #self.Zscan.setText(str(gpgo.getResultZ()))
        #self.Imax.setText(str(gpgo.getResultI())) # Définir une nouvelle fonction dans le module
                                                  # avec self.tau
