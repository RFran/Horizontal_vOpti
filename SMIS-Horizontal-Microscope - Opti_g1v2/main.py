...
#
        ...
        self.Yscan.setText(str(round(-1*gpgo.getResultY(),2)))  # Enl)ever les comentaires tant qui il n'y a pas le module
        self.Zscan.setText(str(round(gpgo.getResultZ(),2)))
        self.Imax.setText(str(round(gpgo.getResultI(),0))) # Définir une nouvelle fonction dans le module
                                                 # avec self.tau
